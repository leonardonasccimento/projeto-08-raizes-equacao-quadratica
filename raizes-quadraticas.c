...
voltar:
    ...
    if (deltaFormaReduzida < 0)
    {
        ...
        if (B1 != 0)
        {
            ...
            else if ((abs(B2) < abs(B1)) && (abs(B1) % abs(B2) == 0))
            {
                B1 /= B2;
                B2 /= B2;
            }
        ...
        else if ((abs(F2) < abs(F1)) && (abs(F1) % abs(F2) == 0))
        {
            F1 /= F2;
            F2 /= F2;
        }
        ...
        if (D1 != 0)
        {
            ...
            else if ((abs(D2) < abs(D1)) && (abs(D1) % abs(D2) == 0))
            {
                D1 /= D2;
                D2 /= D2;
            }
...
void imprimir()
{
    ...
    do
    {
        ...
        {
        case (7):
            calcularFormaReduzida();
            break;
        case (8):
            calcularFormaFracionaria();
            break;
        default:
            continue;
        }
